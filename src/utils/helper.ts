...
export function oauth2(config: any) {
...
export function openPopup({ url, config }: any) {
  return new Promise(resolve => {
...
export function pollPopup({ window, config, requestToken }: any) {
  return new Promise((resolve, reject) => {
    const redirectUri: any = qs.parse(config.redirectUri);
